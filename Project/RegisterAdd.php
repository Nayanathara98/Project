<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
	  ...
	  <div class="bgimg" style="position:absolute;top:7px; left:310px;border:2px solid black;width:1035;height:980;>
        ...
        <input type="text" name="t10">&emsp;&emsp;<input type="text" name="t11"><br><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp&nbsp&nbsp
		<input type="text" name="t12">&emsp;&emsp;<input type="text" name="t13"><br><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp&nbsp&nbsp
		<input type="text" name="t14">&emsp;&emsp;<input type="text" name="t15">&emsp;&emsp;<input type="text" name="t16"><br>
        </div>
        </div><br>
		...
		<div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Exam Date :&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp </label>
        <input type="text" name="t7">
        </div>
        </div><br>
		...
		<div class="col-md-6">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Exam Status :&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp </label>
        <input type="text" name="t8">
        </div>
        </div><br>
		...
		<div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Trail Date :&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp </label>
        <input type="text" name="t7">
        </div>
        </div><br>
		...
		<div class="col-md-6">
        <div class="form-group">
        <label for="exampleInputEmail1">&emsp;&emsp;Trail Status :&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp </label>
        <input type="text" name="t8">
        </div>
        </div><br>
